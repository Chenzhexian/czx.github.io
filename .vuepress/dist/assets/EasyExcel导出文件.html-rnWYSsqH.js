import{_ as n,o as s,c as a,e as t}from"./app-CzSBTTj3.js";const e={},p=t(`<h1 id="easyexcel-导出文件" tabindex="-1"><a class="header-anchor" href="#easyexcel-导出文件"><span>EasyExcel 导出文件</span></a></h1><h2 id="easyexcel导出数据" tabindex="-1"><a class="header-anchor" href="#easyexcel导出数据"><span>EasyExcel导出数据</span></a></h2><h3 id="引入pom文件" tabindex="-1"><a class="header-anchor" href="#引入pom文件"><span>引入pom文件</span></a></h3><div class="language-xml line-numbers-mode" data-ext="xml" data-title="xml"><pre class="language-xml"><code><span class="token comment">&lt;!-- easy-excel --&gt;</span>
