<template>
  <div id="chatbot-iframe"
       data-bot-src="https://www.czxcab.cn/chat/share?shareId=82doc068cwuhsgt3mbyiwjbu"
...
onMounted(() => {
  ...
  ChatBtn.style.cssText =
      'position: fixed; top: 50%; bottom: 1rem; right: 1rem; transform: translateY(-50%); width: 40px; height: 40px; cursor: pointer; z-index: 2147483647; transition: 0;';
